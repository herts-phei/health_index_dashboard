  ...
  moduleServer(
    ...
    function(input, output, session) {
      ...
      output$graph_intro_text<-renderUI({
        ...
        p(paste0("A summary of the indicator for a geography can be generated by selecting the legend on the right. ")
          , style = "font-family:Bahnschrift,garamond,serif;font-size:18px;font-weight:lighter;")
      ...
      output$trend_text<-renderUI({
        ...
        trends <- sig_diff_df() %>% 
          filter(ind == values$selected,
                 AreaName == clickedItem)
          
        p(paste0("There is a ", trends$sig_diff, " ", trends$direction, " trend in ", tolower(as.character(values$selected)), " in ", clickedItem, " over time.")
          , style = "font-family:Bahnschrift,garamond,serif;font-size:18px;font-weight:lighter;")
          ...
          p(paste0("There is a ", trends$sig_diff," ", trends$direction, " trend in ", tolower(as.character(values$selected)), " in Hertfordshire over time.")
            , style = "font-family:Bahnschrift,garamond,serif;font-size:18px;font-weight:lighter;")
